...
이 봇은 기능 확인용 데모 인스턴스이며, 예고 없이 제한되거나 중단될 수 있습니다.  
**프라이버시**(와 저의 서버비)**를 위해 직접 봇을 운영하는 것을 권장합니다.**  
최초 봇 초대 시, 명령어 등록 처리 과정에서 서버 이름과 서버 ID를 로깅합니다. 사용자 메시지 본문은 일반 운영 로그에 기록하지 않습니다.
...
[개인정보 보호 정책](./PRIVACY.md) / [이용 약관](./TERMS.md)
